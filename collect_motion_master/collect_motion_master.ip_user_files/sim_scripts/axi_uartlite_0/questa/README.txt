...
#
# Generated by export_simulation on Wed Jul 20 11:41:22 +0900 2022
#
################################################################################
...
'-reset_run' switch to the './axi_uartlite_0.sh' script.

./axi_uartlite_0.sh -reset_run
...
./axi_uartlite_0.sh -noclean_files

For more information on the script, please type './axi_uartlite_0.sh -help'.
